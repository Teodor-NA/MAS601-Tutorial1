...
%% Animate driven
viewBox = [-1, 10, -1, 4];
animation(animateDriven, tSpan, tEndAnimation, targetFps, spd, ...
    'Driven', viewBox, @drawFunct, pos);

%% Animate sim
viewBox = [-1, 10, -1, 4];
animation(animateSim, Time, tEndAnimation, targetFps, spd, ...
    'Simulated', viewBox, @drawFunct, qT(:, 1:9)');

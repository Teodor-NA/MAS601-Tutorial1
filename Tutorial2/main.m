...
global m1 L1 Jbar1 m2 L2 Jbar2 phi1 phi2 phiDot1 phiDot2 M g Fg1 Fg2 L0 k b Minv
...
%         drawBox(axHandle, qT(i, 1:2), 0, 0.2, 0.2, 'r', 4);
%         drawBox(axHandle, qT(i, 4:5), 0, 0.2, 0.2, 'b', 4);
        if T(i) >= tEnd
            break;
        end
        delta = toc;
